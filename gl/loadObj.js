...
{ 
	...
	if(lotid == 1)
	{
		inf = {obj: infProject.path+'import/nasos_z.fbx', name: 'насос'}
		inf.planeMath = 0.5;
	}
	else if(lotid == 2)
	{
		inf = {obj: infProject.path+'import/kotel_1.fbx', name: 'котел'}
		inf.planeMath = 1.5;
	}
	else if(lotid == 3)
	{
		inf = {obj: infProject.path+'import/budres_900.fbx', name: 'радиатор'}
		inf.planeMath = 0.8;
	}
	else if(lotid == 4)
	{
		inf = {obj: infProject.path+'import/bak_1.fbx', name: 'расширительный бак'}
		inf.planeMath = 0.5;
	}	
	else if(lotid == 5)
	{
		inf = {obj: infProject.path+'import/kollector_1.fbx', name: 'коллектор'}
		inf.planeMath = 0.5;
	}	
