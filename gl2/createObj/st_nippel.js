...
{	
	...
	// нижняя труба 
	{
		var inf = {dlina: x_1, diameter_nr: diameter_nr_1, diameter_vn: diameter_vn_1, rezba_nr: true };	  
		...
		var inf = {dlina: x_3L, diameter_nr: diameter_nr_1, diameter_vn: diameter_vn_1 }; 
		var obj = createSleeveObj_2(inf);
		obj.position.x -= x_3L/2;
		group.add( obj );
		
		var inf = {dlina: x_3R, diameter_nr: diameter_nr_2, diameter_vn: diameter_vn_2 };
		var obj = createSleeveObj_2(inf);
		obj.position.x += x_3R/2; 
		group.add( obj );		
 
		var inf = {dlina: x_2, diameter_nr: diameter_nr_2, diameter_vn: diameter_vn_2, rezba_nr: true };
		var obj = createSleeveObj_2(inf);		
	...
	// кольца
	{		
		var inf = {dlina: x_4, diameter_nr: d_nr, diameter_vn: d_vn, edge_nr: 6, edge_vn: 32 }; 
		var obj = createSleeveObj_2(inf);		
	...
	var name = (cdm.inch_1 != cdm.inch_2) ? 'Ниппель переходной '+name1+'х'+name2 : 'Ниппель '+name1;
