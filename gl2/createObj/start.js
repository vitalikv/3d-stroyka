...
function cr_obj_cat()
{
	...
	if(1==1)
	{
		...
		var step = 0.1;
		var startPos = new THREE.Vector3(-0.8, 1, 0+0.0);	
	...
	if(1==1)
	{
		...
		var n = 0;
		var step = 0.1;
		var startPos = new THREE.Vector3(-0.6, 1, 0+0.0);	
	...
	if(1==1)
	{
		...
		var n = 0;
		var step = 0.1;
		var startPos = new THREE.Vector3(-0.4, 1, 0+0.0);	
	...
	if(1==1)
	{
		...
		var step = 0.1;
		var startPos = new THREE.Vector3(-0.2, 1, 0+0.0);	
	...
	if(1==1)
	{
		...
		var step = 0.1;
		var startPos = new THREE.Vector3(0.0, 1, 0+0.0);	
	...
	if(1==1)
	{
		...
		var step = 0.1;
		var startPos = new THREE.Vector3(1.0, 1, 0+0.0);	
	...
	if(1==1)
	{
		...
		var step = 0.1;
		var startPos = new THREE.Vector3(1.4, 1, 0+0.0);	
	...
	if(1==1)
	{
		...
		var step = 0.1;
		var startPos = new THREE.Vector3(1.6, 1, 0+0.0);	
	...
	if(1==1)
	{
		...
		var step = 0.1;
		var startPos = new THREE.Vector3(1.8, 1, 0+0.0);	
	...
	if(1==1)
	{
		...
		var step = 0.1;
		var startPos = new THREE.Vector3(2.0, 1, 0+0.0);	
	...
	if(1==1)
	{
		...
		var n = 0;
		var step = 0.1;
		var startPos = new THREE.Vector3(2.2, 1, 0+0.0);	
