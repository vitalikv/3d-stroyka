...
function cr_obj_cat()
{
	...
	if(1==2)
	{
		...
		pl_troinik_1({r1: '32', m1: 0.08, offset: new THREE.Vector3(0.2, 1, 2+0.3)});
		pl_troinik_1({r1: '40', m1: 0.095, offset: new THREE.Vector3(0.2, 1, 2+0.2)});
		pl_troinik_1({r1: '50', m1: 0.11, offset: new THREE.Vector3(0.2, 1, 2+0.1)});
		pl_troinik_1({r1: '63', m1: 0.125, offset: new THREE.Vector3(0.2, 1, 2+0.0)});			
		
		pl_troinik_rezba_1({side: 'n', r1: '20', r2: '1/2', m1: 0.07, offset: new THREE.Vector3(0.2, 1, 2+1.3)});
		pl_troinik_rezba_1({side: 'n', r1: '20', r2: '3/4', m1: 0.07, offset: new THREE.Vector3(0.2, 1, 2+1.2)});
		pl_troinik_rezba_1({side: 'n', r1: '25', r2: '1/2', m1: 0.075, offset: new THREE.Vector3(0.2, 1, 2+1.1)});
		pl_troinik_rezba_1({side: 'n', r1: '25', r2: '3/4', m1: 0.075, offset: new THREE.Vector3(0.2, 1, 2+1.0)});
		pl_troinik_rezba_1({side: 'n', r1: '32', r2: '3/4', m1: 0.08, offset: new THREE.Vector3(0.2, 1, 2+0.9)});
		pl_troinik_rezba_1({side: 'n', r1: '32', r2: '1', m1: 0.08, offset: new THREE.Vector3(0.2, 1, 2+0.8)});		
		
		pl_troinik_rezba_1({side: 'v', r1: '20', r2: '1/2', m1: 0.07, offset: new THREE.Vector3(0.2, 1, 2+2.0)});
		pl_troinik_rezba_1({side: 'v', r1: '20', r2: '3/4', m1: 0.07, offset: new THREE.Vector3(0.2, 1, 2+1.9)});
		pl_troinik_rezba_1({side: 'v', r1: '25', r2: '1/2', m1: 0.075, offset: new THREE.Vector3(0.2, 1, 2+1.8)});
		pl_troinik_rezba_1({side: 'v', r1: '25', r2: '3/4', m1: 0.075, offset: new THREE.Vector3(0.2, 1, 2+1.7)});
