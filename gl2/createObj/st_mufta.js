...
{	
	var rezba1 = sizeRezba({size: cdm.inch_1, side: 'v'});
	var rezba2 = sizeRezba({size: cdm.inch_2, side: 'v'});	
	...
	var name1 = cdm.inch_1+'(в)';
	var name2 = cdm.inch_2+'(в)';
	...
	// кольца
	{		
		var inf = {dlina: x_4, diameter_nr: diameter_nr_1+0.002, diameter_vn: diameter_vn_1+0.001, material: metal_1 }; 
		var obj = createSleeveObj_2(inf);		
		obj.position.x -= x_3L + x_1;
		group.add( obj );
		
		var inf = {dlina: x_4, diameter_nr: d_nr, diameter_vn: d_vn, material: metal_1 }; 
		var obj = createSleeveObj_2(inf);		
		group.add( obj );

		var inf = {dlina: x_4, diameter_nr: diameter_nr_2+0.002, diameter_vn: diameter_vn_2+0.001, material: metal_1 }; 
		var obj = createSleeveObj_2(inf);		
		obj.position.x += x_3R + x_2;
		group.add( obj );		
	}	
