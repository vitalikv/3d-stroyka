...
function paramSborkaRad_Odnotrub_Verh_Mp()
{
	...
	inf.list.mp.obj = {};
	inf.list.mp.obj.pr1 = [409, 411];	// мп перехожник от рад к трубе

	inf.list.pp.t = [0.020, 0.025];
	inf.list.pp.pipe = {};
	inf.list.pp.pipe.m1 = [0.020, 0.025];	// трубы к радиаторам
	inf.list.pp.obj = {};
	inf.list.pp.obj.pr1 = [250, 252];	// пп перехожник от рад к трубе
	inf.list.pp.obj.ug1 = [238, 239];	// пп углы для однотруб(без байпаса)
...
function paramSborkaRad_Dvuhtrub_Verh_Mp()
{
	...
	inf.list.pp.pipe.m2 = [0.025, 0.032, 0.040];	// трубы от тройников
	inf.list.pp.obj = {};
	inf.list.pp.obj.pr1 = [250, 250, 250];	// мп перехожник от рад к трубе
...
async function crSborkaRad_Odnotrub_Verh_Mp(cdm)
{
	...
	{		
		...
		q.ugol_2 = {q: new THREE.Quaternion(0, -1, 0, 0)};
	...
	else
	{
		...
		q.ugol_1 = {q: new THREE.Quaternion(0, -1, 0, 0)};
