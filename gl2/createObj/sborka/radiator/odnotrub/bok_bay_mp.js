...
function crSborkaRad_Odnotrub_Bok_Bay_Mp(cdm)
{
	...
	if(inf.side == 'right')
	{
		o.troin_1.quaternion.copy(new THREE.Quaternion().setFromEuler(new THREE.Euler(Math.PI, Math.PI, 0)));
		o.troin_2.quaternion.copy(new THREE.Quaternion().setFromEuler(new THREE.Euler(Math.PI, 0, Math.PI)));
	}
	else
	{
		o.troin_1.quaternion.copy(new THREE.Quaternion().setFromEuler(new THREE.Euler(Math.PI, 0, 0)));
		o.troin_2.quaternion.copy(new THREE.Quaternion().setFromEuler(new THREE.Euler(Math.PI, Math.PI, Math.PI)));
	}	
